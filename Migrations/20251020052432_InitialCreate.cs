        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrgentJustification = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AllocationHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FridgeId = table.Column<int>(type: "int", nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllocationHistories", x => x.AllocationHistoryId);
                    table.ForeignKey(
                        name: "FK_AllocationHistories_AspNetUsers_ActionById",
                        column: x => x.ActionById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AllocationHistories_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AllocationHistories_Fridges_FridgeId",
                        column: x => x.FridgeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Priority = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiagnosisDetails = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    PartsRequired = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FaultReports_AspNetUsers_AssignedTechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicianNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ServiceChecklist = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRecords_AspNetUsers_AssignedTechnicianId",
                        column: x => x.AssignedTechnicianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceHistoryEntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceHistoryEntries", x => x.ServiceHistoryEntryId);
                    table.ForeignKey(
                        name: "FK_ServiceHistoryEntries_AspNetUsers_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceHistoryEntries_Fridges_FridgeId",
                        column: x => x.FridgeId,
                        principalTable: "Fridges",
                        principalColumn: "FridgeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllocationHistories_ActionDate",
                table: "AllocationHistories",
                column: "ActionDate");

            migrationBuilder.CreateIndex(
                name: "IX_AllocationHistories_CustomerId",
                table: "AllocationHistories",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_AllocationHistories_FridgeId",
                table: "AllocationHistories",
                column: "FridgeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecords_AssignedTechnicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceHistoryEntries_FridgeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceHistoryEntries_TechnicianId",
                table: "ServiceHistoryEntries",
                column: "TechnicianId");
        }
